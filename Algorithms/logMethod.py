...
# We will create a logMethod to compare with the one in library, they both should produce results efficiently
# Log Base(target) = x?
def logMethod(target, base):
    ...
    while x >= base:
        x /= base
        division_count += 1
    # If we divided up until x==1, this is great, this is what we return.. otherwise we must bs between that n and
    # n+1.. bs_rem will take in the target, base, and the precision.. method binary searches between 0 and 1 to find
    # what will work..
...
print(math.log(
    314224634523624623463463463462346234634634646323642346346124314224634523624623463463463462346234634634646323642346346124314224634523624623463463463462346234634634646323642346346124314224634523624623463463463462346234634634646323642346346124,
    11))
print(logMethod(
    314224634523624623463463463462346234634634646323642346346124314224634523624623463463463462346234634634646323642346346124314224634523624623463463463462346234634634646323642346346124314224634523624623463463463462346234634634646323642346346124,
    11))
